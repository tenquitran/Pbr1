...
// Lights.
layout(location = 2) uniform vec3 LightPositions[4];
layout(location = 6) uniform vec3 LightColors[4];

layout(location = 10) uniform vec3 CameraPos;

// Materials.
layout(location = 11) uniform sampler2D albedoMap;
layout(location = 12) uniform sampler2D normalMap;
layout(location = 13) uniform sampler2D metallicMap;
layout(location = 14) uniform sampler2D roughnessMap;
layout(location = 15) uniform sampler2D aoMap;
